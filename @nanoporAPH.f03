...
!
!  -----------------
!     num_proc = 6  !  <- size of job: paramAPH.h
!  -----------------
!
...
!*
!     if(linux7) then             !<- paramAPH.h
      praefixs = '/home/mtanaka/MPI_nano/PORW31'
      praefixi = '/home/mtanaka/MPI_nano/porw31' ! read(12) - common by nfs
      praefixc = '/home/mtanaka/MPI_nano/porw31' ! write(13)
      praefixe = '/home/mtanaka/MPI_nano/porw31' ! WRITE_CONF
!     end if
!
      suffix2  = '3'
...
!
      ...
      common/ewald2/ nCLp     ! ip0, paramAPH.h L.4920
!
      integer(C_INT) ifLJ
...
!-----------
!                    **** 
      common/ewald2/ nCLp   ! ,ip0 paramAPH.h
!
...
!     parameter     (nob3=7,iblk3=1)           ! paramAPH.h
!
