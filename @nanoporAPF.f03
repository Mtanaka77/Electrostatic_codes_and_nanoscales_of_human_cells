...
!
!  -----------------
!     num_proc = 6  !  <- size of job: paramAPF.h
!  -----------------
!
...
!*
!     if(linux7) then             !<- paramAPF.h
      praefixs = '/home/mtanaka/MPI_nano/PORV21'
      praefixi = '/home/mtanaka/MPI_nano/porv21' ! read(12) - common by nfs
      praefixc = '/home/mtanaka/MPI_nano/porv21' ! write(13)
      praefixe = '/home/mtanaka/MPI_nano/porv21' ! WRITE_CONF
!     end if
!
      suffix2  = '3'
!
...
!
      ...
      common/ewald2/ nCLp     ! ip0, paramAPF.h L.3920
!
      integer(C_INT) ifLJ
...
!
        ...
        do j= 1,my-2
        do i= 1,mx-2
        rho(i,j,k)= -4.d0*pi*rho(i,j,k)/(dec2(i,j,k)*(ghx(i)*ghy(j)*ghz(k)))
        pot(i,j,k)= 1.d-3*(ranff(0.) -0.5)  ! random seed
        end do 
        end do
        end do
!
...
!-----------
!                    **** 
      common/ewald2/ nCLp   ! ,ip0 paramAPF.h
!
...
!     parameter     (nob3=7,iblk3=1)           ! paramAPF.h
!
