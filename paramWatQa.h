...
!
      parameter (praefixs='/home/mtanaka/MPI_nano/PORW32')
      parameter (praefixi='/home/mtanaka/MPI_nano/porw32') ! read(12) - common by nfs
      parameter (praefixc='/home/mtanaka/MPI_nano/porw32') ! write(13)
      parameter (praefixe='/home/mtanaka/MPI_nano/porw32') ! WRITE_CONF
      parameter (suffix2='3a',suffix1='3a',suffix0='3',kstart=0)
!     parameter (suffix2='3b',suffix1='3a',suffix0='3',kstart=1) ! for restart
! 
      parameter (np0=50,nq0=300,nr0=95000)  ! kl,km,kn=29x29x60, x 5 atoms
