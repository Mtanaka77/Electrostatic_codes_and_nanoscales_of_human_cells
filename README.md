...
The five-atom TIP5P water model is selected in the nanopore problem.
The charge inversion and ion transport phenomena are studied for living cells, and the electrostatic molecular dynamics simulations are execcuted (Refs. 1-5, 10).
