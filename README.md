...
The program starts with, (i) the parallelization and parameters setups, (ii) the initialization of
...
and (iv) closing of the code /gclose/. The run is about one hour, and graphic outputs are shown 
in expl07.77a.pdf.
