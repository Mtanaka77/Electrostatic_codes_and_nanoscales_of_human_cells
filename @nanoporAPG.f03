...
!*                                                               *
!*   Gamma = Bjerrum/(aLJ*kT) = e**2/(epsLJ*aLJ*kT)              *
...
!*   /LJ_forces/  Lennard-Jones potential, L.1315, 2160-         *
!*   /sprmul/     Spring forces, L.1320, 2430-                   * 
!*   /reflect_endpl/ Particles boundary, L.2820-                 *
!*                                                               *
!*   /init/       Setups from /RUN_MD/, L.3700-                  *
!*   /poissn/     Poisson solver, L.5540-                        *
!*   /emcof3/     EM forces, closed boundary, L.5670-            *
!*     /bound_s/    for it > 1, L.6130                           * 
!*   /cresmd/-/avmult/  Conjugate residual method, L.6650-       *
...
!     if(linux7) then             !<- paramAPG.h
      praefixs = '/home/mtanaka/MPI_nano/PORW21'
      praefixi = '/home/mtanaka/MPI_nano/porw21' ! read(12) - common by nfs
      praefixc = '/home/mtanaka/MPI_nano/porw21' ! write(13)
      praefixe = '/home/mtanaka/MPI_nano/porw21' ! WRITE_CONF
!     end if
!
      suffix2  = '3'
!
...
!
      ...
      vzs(i)= dgaus2(vmax2)
!
      if(i.le.nCLp+30 .and. io_pe.eq.1) then
        OPEN (unit=11,file=praefixc//'.06'//suffix2,             &
              status='unknown',position='append',form='formatted')
...
!
      if(io_pe.eq.1) then
        OPEN (unit=11,file=praefixc//'.06'//suffix2,             &
              status='unknown',position='append',form='formatted')
!
        write(11,*) '# Initial volocity of water...'
!
        do i= nCLp+1,nCLp+10
        write(11,770) i,vx(i),vy(i),vz(i)
  770   format('i,vx-vz(i)=',i8,1p3d12.3)
        end do
!
        close(11)
      end if
...
!*******************************
!
      vmax1= 6.d0*vth/sqrt(38.d0)  !<- mass of K(+)
