...
!
!  -----------------
!     num_proc = 6  !  <- size of job: paramAPG.h
!  -----------------
!
...
!*
!     if(linux7) then             !<- paramAPG.h
      praefixs = '/home/mtanaka/MPI_nano/PORV11'
      praefixi = '/home/mtanaka/MPI_nano/porv11' ! read(12) - common by nfs
      praefixc = '/home/mtanaka/MPI_nano/porv11' ! write(13)
      praefixe = '/home/mtanaka/MPI_nano/porv!1' ! WRITE_CONF
!     end if
!
      suffix2  = '3'
!
...
!-----------
!                    **** 
      common/ewald2/ nCLp   ! ,ip0 paramAPG.h
!
...
!     parameter     (nob3=7,iblk3=1)           ! paramAPG.h
!
