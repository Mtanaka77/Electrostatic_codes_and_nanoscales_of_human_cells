...
!
!  -----------------
!     num_proc = 6  !  <- size of job: paramWatPa.h
!  -----------------
!
...
!
      ...
      common/ewald2/ nCLp     ! ip0, paramWatPa.h L.4320
!
      integer(C_INT) ifLJ
...
!-----------
!                    **** 
      common/ewald2/ nCLp   ! ,ip0 paramWatPa.h
!
...
!     parameter     (nob3=13)           ! paramWatPa.h
!
...
!
      include    'paramWatPa.h'
!
!     integer(C_INT) nob3     !<- paramWatPa.h
!     parameter     (nob3=13)
!
!*---------------------------------------------------------------------
